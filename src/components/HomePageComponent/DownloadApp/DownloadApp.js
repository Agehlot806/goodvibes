      ...
      <div className='download-app-area'>
        <Row>
          ...
          <Col lg={6} md={6}>
            ...
            <p className='download-para'>Vix te soleat eirmod civibus. Ius ad autem dicam exerci, sed et erremasc simulacrum phaedrum, ex latine minimum has. No mei case possit reformidans assenna. Mea nobis sum putent discere no. Duo ea sum homero senserit mea fugit.</p>
